 ...
 *   の実装の雰囲気を掴めればOKです。
 */
export const Training004 = ({
    handleButton2Click,
    messageForButton4Clicked,
}: Props) => {
    // Button3をクリックしたときに実行
    ...
    return (
        <Card sx={TRAINING_CARD_SX_STYLE}>
            <Typography variant="h6">オンボーディングワーク004</Typography>
            ...
            <Stack spacing={2} direction="row" alignItems="center">
                <Button
                    ...
                    onClick={() => {
                        console.log(
                            "このボタンがクリックされると、ブラウザの開発者ツールのコンソールにこのメッセージが表示されます。",
                        );
                    }}
                >
                    ボタン1
                ...
                {/* TODO 7 : implement me !! */}
                <Button variant="text" onClick={handleButton4Click}>
                    ボタン4
                </Button>
            </Stack>
        </Card>
